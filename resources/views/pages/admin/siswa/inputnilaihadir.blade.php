...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Input Nilai Kehadiran Siswa {{$item->nama}}</h1>

        <div class="card shadow">
            <div class="card-body">
              <form action="/siswa/{{$item->id}}/{{$hadir->id}}/nilaiupdatehadir" method="POST">
                @csrf
                <div class="form-group">
                  <label for="nama">Kehadiran</label>
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="nama"><i class="far fa-id-card"></i></span>
                    </div>
                    <input type="text" class="form-control @error('nama') is-invalid @enderror" placeholder="nama" name="nama" value="{{$hadir->nama}}" disabled>
                    @error('nama')
