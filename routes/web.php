...
Route::prefix('/')
    ...
    ->group(function(){
        ...
        Route::group(['middleware' => ['auth', 'check:admin']], function(){
            ...
            Route::get('siswa/{siswa}/destroy', 'SiswaController@destroy')->name('deletesiswa');
            ...
            Route::get('guru/{guru}/edit', 'GuruController@edit')->name('guruedit');
            Route::put('guru/{guru}/update', 'GuruController@update');
            Route::get('guru/{guru}/destroy', 'GuruController@destroy')->name('gurudelete');
            ...
            Route::get('thnakademik/{thnakademik}/hapus', 'ThnakademikController@hapus')->name('thnakahapus');
